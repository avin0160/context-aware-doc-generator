...
try:
    # Import the new generic documentation system
    from comprehensive_docs import generate_comprehensive_documentation
    AI_AVAILABLE = True
    print("✅ Generic documentation system imported successfully")
except ImportError as e:
    print(f"⚠️ Import warning: {e}")
    print("📝 Running in demo mode without documentation generation")
    AI_AVAILABLE = False
